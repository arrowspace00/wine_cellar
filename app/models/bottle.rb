class Bottle < ActiveRecord::Base
	...
	validates :bin, :presence => true, :length => { :minimum => 4, :maximum => 4 }
								
	validates_uniqueness_of :bin, :message => "- - This bin# is already in use. Please choose a bin# that is not being used."
